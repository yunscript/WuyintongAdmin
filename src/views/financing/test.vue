  ...
  <div class="app-container">
    <el-row>
      <el-col :span="3">
        ...
        <el-button type="text" @click="dialogVisible = true">点击打开 sds觉得简单Dialog</el-button>
      </el-col>
      <el-col :span="21">
        <el-tabs type="card">
    ...
    <test-dialog :testDialog="testDialog" v-on:testVisable="testVisable"></test-dialog>
  </div>
</template>
<script>
...
import TestDialog from './test_dialog.vue'
...
export default {
  ...
  methods: {
    ...
    handleTest(row) {
      ...
      console.log('-------------' + this.testDialog.visible)
    },
